...
# 如何使用
> 你必须安装[BepinEx](https://github.com/BepInEx/BepInEx)模组（Mono版）才能使用此作弊模组

- 下载[Releases](https://github.com/xiaodo1337/Content-Warning-Cheat/releases)内的plugins.zip压缩包
